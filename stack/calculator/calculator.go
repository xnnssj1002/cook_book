...
import (
	"fmt"
	"github.com/xnnssj1002/cook_book/stack/achiever"
	"strconv"
)
...
type Calculator struct {
	nums      *achiever.ArrayIntStack
	operators *achiever.ArrayStack
	exp       string
}
...
func NewCalculator(exp string) *Calculator {
	return &Calculator{
		nums:      achiever.NewArrayIntStack(),
		operators: achiever.NewArrayStack(),
		exp:       exp,
	}
}
